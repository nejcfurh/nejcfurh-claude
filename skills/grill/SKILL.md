...
Once alignment is reached, write a short execution plan - inline in the conversation, or to a file if the user prefers (ask where) - and hand off to /build for implementation.
