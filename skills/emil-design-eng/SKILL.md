...
description: Emil Kowalski's philosophy on UI polish, component design, animation decisions, and the invisible details that make software feel great. Use when building or polishing UI components (buttons, popovers, tooltips, toasts, modals), implementing or tweaking animations and transitions, or when the user asks to make an interface feel more polished, premium, or delightful.
---
